...
local aliveFolder = moduleSettings["Alive Folder"].Value or workspace.Humanoids
...
local projectileFolder = moduleSettings["Projectile Folder"].Value or workspace.Debris
